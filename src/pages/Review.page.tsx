    ...
    <div className=" text-white py-16">
      <div className="container mx-auto  flex flex-col md:flex-row my-2 md:my-2 shadow-inner ">
        <div className="flex flex-col w-full lg:w-1/3 p-8">
          <p className="text-3xl  tracking-loose">Write review for me</p>
          ...
          <div className="container w-full px-4">
            <div className="flex flex-wrap justify-center">
              <div className="w-full lg:w-6/12 px-4">
                <div className="relative flex flex-col min-w-0 break-words my-6 shadow-inner shadow-black rounded-lg bg-gray-200">
